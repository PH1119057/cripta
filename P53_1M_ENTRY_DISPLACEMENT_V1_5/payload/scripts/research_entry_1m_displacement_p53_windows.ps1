...
Write-Host "============================================================="
Write-Host "P53 1M ENTRY DISPLACEMENT V1.5"
...
Write-Host "1m layer: local public-trade tape -> causal continuous 1m OHLC; first public-trade archive boundary is seeded by the matching frozen 5m open."
Write-Host "Equivalence gate: continuous trade-derived 1m must reproduce frozen 5m OHLCV exactly."
