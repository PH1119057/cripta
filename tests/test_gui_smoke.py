...
class GuiSmokeTests(unittest.TestCase):
    ...
    def test_live_connection_buttons_show_immediate_feedback(self) -> None:
        ...
        # The runtime connection callback is asynchronous. A refresh can therefore
        # observe DISCONNECTED briefly after connect_read_only() returns; that
        # transient snapshot must not erase the visible connecting state.
