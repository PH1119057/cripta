...
def main() -> int:
    ...
    config = P52Config(
        mfe_milestones_pct=cast(tuple[float, ...], _parse_floats(args.mfe_milestones_pct)),
        stop_candidates_pct=cast(tuple[float, ...], _parse_floats(args.stop_candidates_pct)),
        continuation_targets_pct=cast(
            tuple[float, ...], _parse_floats(args.continuation_targets_pct)
        ),
