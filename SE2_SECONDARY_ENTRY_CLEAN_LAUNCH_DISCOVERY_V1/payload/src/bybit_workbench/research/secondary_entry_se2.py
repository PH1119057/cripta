    ...
    *,
    ...
    for adverse in BASE_MIN_ADVERSE_PCT:
        for rebound in BASE_REBOUND_PCT:
            ...
            base_stats[(adverse, rebound)] = (ev, len(selected))
    ...
    selected = select_nonredundant_candidates(metrics, by_id, events)
    bootstrap_rows = [
        bootstrap_ev(
    ...
    _write_csv(
        ...
        [_jsonable_dataclass(metric) for metric in selected],
    )
    _write_csv(
    ...
    selection_payload = {
        ...
        "prebootstrap_candidates": [_jsonable_dataclass(metric) for metric in selected],
    ...
    provenance = {
        ...
        "candidate_grid_count": len(grid),
        "prebootstrap_candidate_count": len(selected),
