ENTRY BOT LIVE SCANNER P48 V1.3 MYPY FIX
============================
...
Установка из C:\cripta:
  ...
  powershell -ExecutionPolicy Bypass -File .\ENTRY_BOT_LIVE_SCANNER_P48_V1_3_MYPY_FIX\APPLY_ENTRY_BOT_LIVE_SCANNER_P48_V1_3.ps1
...
V1.3 installer runs Ruff against a full post-patch src+tests overlay, matching check_windows.ps1 path topology.
