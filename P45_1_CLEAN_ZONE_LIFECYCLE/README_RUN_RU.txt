...
1) Распаковать папку P45_1_CLEAN_ZONE_LIFECYCLE прямо в C:\cripta
2) Из C:\cripta выполнить:

powershell -ExecutionPolicy Bypass -File .\P45_1_CLEAN_ZONE_LIFECYCLE\APPLY_P45_1_CLEAN_ZONE_LIFECYCLE.ps1
