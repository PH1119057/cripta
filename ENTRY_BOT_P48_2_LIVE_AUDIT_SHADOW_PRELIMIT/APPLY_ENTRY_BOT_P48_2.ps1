...
Write-Host "============================================================="
Write-Host "ENTRY BOT P48.2 LIVE AUDIT + SHADOW PRE-LIMIT - PRECHECK"
...
$BackupRoot = Join-Path $ProjectRoot "patch_backups\ENTRY_BOT_P48_2_$Timestamp"
$BackedUp = 0
...
Write-Host "Resulting build: v0.8.5 - P48.2"
