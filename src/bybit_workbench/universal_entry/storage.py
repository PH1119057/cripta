    ...
    return canonical_json(
        {
            ...
            "entry_reference_policy": plan.entry_reference_policy,
            "local_entry_policy": plan.local_entry_policy,
            "context_feature_policy": plan.context_feature_policy,
            "context_ranking_policy": plan.context_ranking_policy,
