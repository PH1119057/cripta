    ...
    class MainWindow(QMainWindow):
        ...
        def _build_center_panel(self) -> QWidget:
            ...
            try:
                ...
                for key, color, label, width in (
                    ...
                    ("break_even", "#a78bfa", "Безубыток {value:0.6g}", 1.2),
        ...
        def refresh_from_model(self, force: bool = False) -> None:
            ...
            position_values = (
                ...
                ("break_even", _number(state.position_break_even_price)),
        ...
        def _render_chart(self, state: Any) -> None:
            ...
            if self._chart is not None:
                ...
                values = {
                    ...
                    "break_even": state.position_break_even_price,
        ...
        def _render_positions(self, state: Any) -> None:
            ...
            values = (
                ...
                _number(state.position_break_even_price),
