...
def _quantile_hours(values: Sequence[float], q: float) -> float | None:
...
def summarize(rows: Sequence[ReplayResult]) -> dict[str, Any]:
    ...
    return {
        ...
        "target_duration_p75_hours": _quantile_hours(target_durations, 0.75),
        "target_duration_p90_hours": _quantile_hours(target_durations, 0.90),
        "target_duration_p95_hours": _quantile_hours(target_durations, 0.95),
        ...
        "stop_duration_p90_hours": _quantile_hours(stop_durations, 0.90),
