...
$argsList = @(
    "-m", "bybit_workbench.research.exit_break_even_v13",
    "--root", $root,
...
Write-Host "============================================================="
Write-Host "P46 EXIT PATH AUDIT - CORRECTED P45 REPLAY"
...
try {
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "P46 Exit Path Audit / corrected P45 replay failed."
    }
}
finally {
    Pop-Location
