...
Write-Host "============================================================="
Write-Host "P53 1M ENTRY DISPLACEMENT V1.4"
...
Write-Host "1m layer: local public-trade tape -> causal continuous 1m OHLC; dataset boundary is seeded by frozen first 5m open."
