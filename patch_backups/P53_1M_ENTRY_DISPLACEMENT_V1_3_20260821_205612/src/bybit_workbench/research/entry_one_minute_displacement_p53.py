...
P53_VERSION = "P53_1M_ENTRY_DISPLACEMENT_V1_2"
CACHE_VERSION = "P53_1M_OHLC_CACHE_V2"
...
class P53Config:
    ...
    def __post_init__(self) -> None:
        if self.expected_signals != EXPECTED_SIGNALS:
            raise ValueError("P53 V1.2 is frozen to the 1063 Entry V1 ALL9 cohort")
        if self.horizon_hours != DEFAULT_HORIZON_HOURS:
            raise ValueError("P53 V1.2 deeper-entry availability horizon is frozen to 3 hours")
    ...
    *,
    ...
    if cache_path.is_file() and meta_path.is_file() and archive_path.is_file():
        ...
        compatible = (
            ...
            and meta.get("zero_trade_fill") == "previous_close_flat_zero_volume"
        )
        if compatible:
    ...
    _write_json(
        meta_path,
        {
            ...
            "rows": len(candles),
            "zero_trade_fill": "previous_close_flat_zero_volume",
