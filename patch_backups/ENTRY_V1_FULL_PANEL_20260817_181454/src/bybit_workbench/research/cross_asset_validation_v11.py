...
def build_validation_summary(
    ...
    *,
    ...
    return {
        "protocol": "P41 frozen cross-asset validation; no LINK outcome was used to tune Entry V1",
        ...
        "interpretation_rules": [
            ...
            (
                ...
                "pause, and core outcomes retain the same direction and broadly similar "
                "magnitude on LINK."
            ),
            (
            ...
            (
                "A strong LINK result increases confidence but is not proof because "
                "crypto assets share market-wide factors."
            ),
        ],
    }
...
def _write_markdown(path: Path, summary: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            "",
            (
                "P41 deliberately does not auto-accept or auto-reject the concept. "
                "The LINK result is a cross-asset validation, not a tuning pass."
            ),
            "",
        ]
    )
