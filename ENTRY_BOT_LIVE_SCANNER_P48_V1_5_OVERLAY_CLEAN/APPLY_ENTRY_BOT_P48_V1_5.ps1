...
Write-Host "============================================================="
Write-Host "ENTRY BOT P48 V1.5 OVERLAY CLEAN - PRECHECK"
...
$Stage = Join-Path ([System.IO.Path]::GetTempPath()) (
    "entry_bot_p48_v15_overlay_" + [Guid]::NewGuid().ToString("N")
)
...
$BackupRoot = Join-Path $ProjectRoot "patch_backups\ENTRY_BOT_P48_V1_5_$Timestamp"
$BackedUp = 0
