...
Статус: **POST-LINK verdict сохранён как исторический промежуточный вывод. Финальный freeze Entry V1 отложен до full-panel validation на 9 активах.**

Важно: цифры UNI/LINK ниже не отменяются, но больше не считаются достаточной cross-asset базой для финальной классификации hard rules / soft context / veto.
