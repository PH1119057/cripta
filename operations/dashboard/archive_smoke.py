...
REQUIRED = (
    ...
    "торговая_база/mayak_v2.liquidations.jsonl",
    "торговая_база/strategy_dispatcher.runs.jsonl",
    "торговая_база/strategy_dispatcher.assessments.jsonl",
    "торговая_база/research_context.event_links.jsonl",
