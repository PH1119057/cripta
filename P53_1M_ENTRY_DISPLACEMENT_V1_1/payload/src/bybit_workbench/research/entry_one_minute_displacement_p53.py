...
P53_VERSION = "P53_1M_ENTRY_DISPLACEMENT_V1_1"
...
class P53Config:
    ...
    def __post_init__(self) -> None:
        if self.expected_signals != EXPECTED_SIGNALS:
            raise ValueError("P53 V1.1 is frozen to the 1063 Entry V1 ALL9 cohort")
        if self.horizon_hours != DEFAULT_HORIZON_HOURS:
            raise ValueError("P53 V1.1 deeper-entry availability horizon is frozen to 3 hours")
