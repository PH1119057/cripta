...
Write-Host "============================================================="
Write-Host "P53 1M ENTRY DISPLACEMENT V1.1"
...
Write-Host "1m layer: local public-trade tape -> causal 1m OHLC."
Write-Host "Equivalence gate: trade-derived 1m must reproduce frozen 5m OHLC."
