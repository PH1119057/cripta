...
$PatchName = "P53_1M_ENTRY_DISPLACEMENT_V1_1"
$ProjectRoot = (Get-Location).Path
$PatchRoot = $PSScriptRoot
$ManifestPath = Join-Path $PatchRoot "MANIFEST.json"
$PayloadRoot = Join-Path $PatchRoot "payload"
$TempRoot = Join-Path ([System.IO.Path]::GetTempPath()) ("Cripta_P53_1_1_" + [guid]::NewGuid().ToString("N"))
...
try {
    ...
    Write-Host "V1.1 fixes rejected V1 patch-preparation errors; research contract is unchanged."
    Write-Host "============================================================="
